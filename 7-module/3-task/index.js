...
<div class="slider">
  ...
  onSliderClickEvent = (event) => {
    ...
    // удаление/добавление класса .slider__step-active
    ...
    // событие изменения value для всплытия
